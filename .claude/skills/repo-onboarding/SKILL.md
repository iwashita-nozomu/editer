...
1. Read `README.md`, `documents/README.md`, and `agents/README.md`.
1. Check `QUICK_START.md` and `scripts/README.md` for commands.
1. If the task touches experiments, read `documents/experiment-workflow.md`.
