...
- `memory/methods/`
  - method-based learning の蓄積
- `memory/candidates/`
  - run-local から上げた未昇格 observation
- `notes/failures/`
...
1. 会話から得た durable preference を `memory/global/USER_PREFERENCES.md` に追記したか
1. agent-side の作業哲学、対話上の再発防止、task retrospective を `memory/candidates/`、`memory/methods/`、`memory/global/AGENT_PHILOSOPHY.md` の適切な層へ追記したか
