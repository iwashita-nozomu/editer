...
1. intake review で scope、non-goals、acceptance criteria を確認します。
1. requirements review で requirement の抜けと曖昧さを確認します。
1. design review で file plan、check plan、rollback plan を確認します。
1. 実装中に checkpoint review を入れ、設計逸脱を早めに落とします。
1. validation 実行後に verification review を行い、必要なら追加修正や追加検証を行います。
1. final acceptance review で受け入れ条件達成と docs 同期を確認します。
...
- intake review、requirements review、design review、checkpoint review、verification review、final acceptance review、audit review が揃っていること
